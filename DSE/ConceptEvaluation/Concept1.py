...
reserve_fuel_frac = 0.1113123381;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2583559351;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.08815796594;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
