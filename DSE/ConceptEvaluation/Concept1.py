...
#%% ------------------------ INPUTS ------------------------
MTOW = 70337.48373*g;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 41013.01245*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 11.9*1000*g;						# Max fuel weight [N]
cj = 0.00001145;									# Specific fuel consumption [kg/Ns]
L_D = 26.9;										# Lift to drag ratio [-]
h = 11000;										# Cruise altitude [m]
e = 0.7023214054;										# Ozwald efficiency [-]
landdis = 2000;									# Landing distance [m]
Cd0 = 0.01227;									# Zero lift drag coefficient [-]
...
Cl_max_takeoff = array([1.9, 2.0, 2.1]);		# Cl_max for take off [-]
...
reserve_fuel_frac = 0.0983342011;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.3342030073;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.1193967182;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
