...
#%% ------------------------ INPUTS ------------------------
MTOW = 76021.81016*g;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 42755.46561*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 16.5*1000*g;						# Max fuel weight [N]
...
reserve_fuel_frac = 0.1260691568;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2573925999;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.08776121237;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
