...
#%% ------------------------ INPUTS ------------------------
MTOW = 721953.6175;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 41701.64016*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 15.5*1000*g;						# Max fuel weight [N]
cj = 1.11E-05;									# Specific fuel consumption [kg/Ns]
...
reserve_fuel_frac = 0.1113445158;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2741783147;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.0946744779;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
