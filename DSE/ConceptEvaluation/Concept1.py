...
#%% ------------------------ INPUTS ------------------------
MTOW = 76240.99575*g;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 42978.72299*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 17.1*1000*g;						# Max fuel weight [N]
cj = 0.00001214252311;									# Specific fuel consumption [kg/Ns]
L_D = 18.7;										# Lift to drag ratio [-]
...
reserve_fuel_frac = 0.1140523036;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2546937839;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.08664792903;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
