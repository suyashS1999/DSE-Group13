...
#%% ------------------------ INPUTS ------------------------
MTOW = 76927.3527*g;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 43148.47107*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 18.25*1000*g;						# Max fuel weight [N]
cj = 1.48e-05;									# Specific fuel consumption [kg/Ns]
L_D = 20.65840792;										# Lift to drag ratio [-]
...
reserve_fuel_frac = 0.1135161021;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2473515065;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.08362574683;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
