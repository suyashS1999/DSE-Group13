...
#%% ------------------------ INPUTS ------------------------
MTOW = 79584.74877*g;							# Max Take off Weight [N]
MLW = 0.86*MTOW									# Max Landing Weight [N]
OEW = 45818.75425*g;							# Operational empty weight [N]
Payload_max = 20*1000*g;						# Payload weight [N]
Max_Fuel_cap = 18.2*1000*g;						# Max fuel weight [N]
cj = 0.0000120338;									# Specific fuel consumption [kg/Ns]
L_D = 17.9;										# Lift to drag ratio [-]
...
reserve_fuel_frac = 0.1150263091;						# Reserve fuel fraction [-]
pre_cruise_fuel_frac = 0.2561356319;					# Pre cruise fuel fraction [-]
post_cruise_fuel_frac = 0.08724358068;					# Post cruise fuel fraction [-]
#%% ------------------------ Main ------------------------
